...
namespace UnitTests.Core.Notifications;

public sealed class CreateNotificationUseCaseFixture : BaseCoreFixture<CreateNotificationRequest, CreateNotificationUseCase>
{
