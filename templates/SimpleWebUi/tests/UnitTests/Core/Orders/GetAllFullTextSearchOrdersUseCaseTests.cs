...
using Core.Orders;
using UnitTests.Core.Common;

namespace UnitTests.Core.Orders;

public sealed class GetAllFullTextSearchOrdersUseCaseFixture : BaseCoreFixture<BaseFullTextSearchPaginatedRequest, GetAllFullTextSearchOrdersUseCase>
{
